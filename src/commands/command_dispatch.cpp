...
bool WriteTruthReport() {
  ...
  if (!load.ok || !world.summary.coreExists || !harsh.fightWorked || !portal.enteredCrackPlane ||
      ...
      !building.iceMeltedToWater || !building.buildPanelUsable || !save.noDrift ||
      !save.deathDidNotRewindWorld || !save.reincarnationBootstrapReady || !save.schemaChangeReported) {
